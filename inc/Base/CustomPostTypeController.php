...
class CustomPostTypeController extends BaseController {
    ...
    public function register(){
        ...
        $this->callbacks = new CustomPostTypeCallbacks();
    ...
    public function setSubPages(){
        $this->subPages = [
            [
                ...
                'menu_slug' => 'benzee_cpt',
                'callback' => [$this->callbacks, 'CustomPostTypeTemplate'],
            ]
    ...
    public function setSettings(){
        $args =  [
            [
                'option_group' => 'benzee_plugin_cpt_setting',
                'option_name' => 'benzee_plugin_cpt',
                'callback' => [$this->callbacks, 'cptSanitize'],
            ]
        ];
    ...
    public function setSections(){
        $args = [
            [
                ...
                'callback' => [$this->callbacks, 'cptSectionManager'],
                'page' => 'benzee_cpt'
            ]
        ];
    ...
    public function registerCpt(){
        foreach ($this->customPostTypes as $post_type){
